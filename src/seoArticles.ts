...
export const SEO_ARTICLES: Record<string, SeoArticle> = {
  homepage: {
    title: "India's Ultimate Nursing Officer CBT Exam Preparation Portal",
    subtitle: "Complete Career Guide & High-Yield Syllabus Analysis for AIIMS NORCET, ESIC, RRB, JIPMER, and State PSC Staff Nurse Exams",
    keywords: ["AIIMS NORCET preparation", "ESIC nursing officer syllabus", "RRB staff nurse model papers", "nursing competitive exams India", "CBT mock test free nursing"],
    contentHtml: `
      <div class="prose max-w-none text-[#c9d1d9] font-sans space-y-8">
        <section class="space-y-4">
          <h2 class="text-xl md:text-2xl font-extrabold text-white tracking-tight border-b border-[#1e293b] pb-2">
            1. Overview of Central Government Nursing Officer Recruitment in India
          </h2>
          <p class="text-sm text-[#8b949e] leading-relaxed">
            Securing a position as a <strong>Nursing Officer</strong> in premier central government institutions like the <strong>All India Institute of Medical Sciences (AIIMS)</strong>, <strong>Employees' State Insurance Corporation (ESIC)</strong>, and <strong>Railway Recruitment Board (RRB)</strong> is the pinnacle of a nursing professional's career in India. These highly coveted posts offer excellent pay matrices (Level 7 of the 7th Pay Commission, with a basic salary starting at Rs. 44,900/-), job security, and clinical advancement opportunities.
          </p>
          <p class="text-sm text-[#8b949e] leading-relaxed">
            However, with over 1.5 lakh aspirants competing for a few thousand vacancies annually, the selection ratio is highly competitive. Preparation requires more than rote memorization; it demands a deep conceptual understanding of nursing sciences, clinical reasoning, drug pharmacology, pediatric care milestones, and rapid decision-making in a high-pressure <strong>Computer Based Test (CBT)</strong> environment.
          </p>
        </section>

        <section class="space-y-4">
          <h2 class="text-xl md:text-2xl font-extrabold text-white tracking-tight border-b border-[#1e293b] pb-2">
            2. Major Competitive Nursing Exams at a Glance
          </h2>
            ...
            <table class="w-full text-left border-collapse text-xs md:text-sm">
              <thead>
                <tr class="bg-[#111827] text-white border-b border-[#1e293b]">
                  <th class="p-3 font-extrabold">Exam Board</th>
                  <th class="p-3 font-extrabold">Core Focus Areas</th>
                  <th class="p-3 font-extrabold">Negative Marking</th>
                  <th class="p-3 font-extrabold">Difficulty Level</th>
                </tr>
              </thead>
              <tbody class="divide-y divide-[#1e293b]">
                <tr>
                  <td class="p-3 font-bold text-[#58a6ff]">AIIMS NORCET</td>
                  <td class="p-3 text-[#8b949e]">Scenario-based clinical situations, OSCE questions, image-based diagnostics.</td>
                  <td class="p-3 text-[#ff7b72] font-semibold">1/3rd (0.33)</td>
                  <td class="p-3"><span class="bg-red-500/10 text-red-400 border border-red-500/20 px-2 py-0.5 rounded font-bold">Very High</span></td>
                </tr>
                <tr>
                  <td class="p-3 font-bold text-[#58a6ff]">ESIC Staff Nurse</td>
                  <td class="p-3 text-[#8b949e]">Fundamentals, pharmacology, community health, general awareness, aptitude.</td>
                  <td class="p-3 text-[#ff7b72] font-semibold">1/4th (0.25)</td>
                  <td class="p-3"><span class="bg-amber-500/10 text-amber-400 border border-amber-500/20 px-2 py-0.5 rounded font-bold">High</span></td>
                </tr>
                <tr>
                  <td class="p-3 font-bold text-[#58a6ff]">RRB Staff Nurse</td>
                  <td class="p-3 text-[#8b949e]">General sciences, mathematics, reasoning, basic anatomy and physiology.</td>
                  <td class="p-3 text-[#ff7b72] font-semibold">1/3rd (0.33)</td>
                  <td class="p-3"><span class="bg-amber-500/10 text-amber-400 border border-amber-500/20 px-2 py-0.5 rounded font-bold">High</span></td>
                </tr>
                <tr>
                  <td class="p-3 font-bold text-[#58a6ff]">WBHRB Grade II</td>
                  <td class="p-3 text-[#8b949e]">Midwifery, pediatric nursing, clinical procedures, institutional protocols.</td>
                  <td class="p-3 text-neutral-400">Varies</td>
                  <td class="p-3"><span class="bg-green-500/10 text-green-400 border border-green-500/20 px-2 py-0.5 rounded font-bold">Medium</span></td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        <section class="space-y-4">
          <h2 class="text-xl md:text-2xl font-extrabold text-white tracking-tight border-b border-[#1e293b] pb-2">
            3. High-Yield Subject Wise Syllabus Blueprint
          </h2>
          <p class="text-sm text-[#8b949e] leading-relaxed">
            Standardizing your preparation according to the weightage of subjects is essential. Based on previous years' analysis of NORCET and ESIC exams, the following clinical subjects carry the highest marks:
          </p>
          <ul class="list-disc list-inside text-sm text-[#8b949e] pl-2 space-y-2">
            <li>
              <strong class="text-white">Medical-Surgical Nursing (30-35% weightage):</strong> Focus on cardiovascular conditions (myocardial infarction, ECG interpretation, blockages), renal systems (chronic kidney disease stages, dialysis parameters), and respiratory nursing (COPD, ventilator modes).
            </li>
            <li>
              <strong class="text-white">Obstetrical & Midwifery Nursing (15-20% weightage):</strong> Stages of labor, partograph plotting, high-risk conditions such as pre-eclampsia (magnesium sulfate protocols), placenta previa, and fetal shunts.
            </li>
            <li>
              <strong class="text-white">Fundamentals of Nursing (15% weightage):</strong> Vital signs, intravenous calculation formulas, blood transfusion protocols, wound healing stages, and surgical asepsis techniques.
            </li>
            <li>
              <strong class="text-white">Pharmacology & Toxicology (10% weightage):</strong> Standard therapeutic levels (Digoxin, Lithium), antidote mechanisms (Heparin/Protamine, Warfarin/Vitamin K), and critical care psychopharmacology.
            </li>
          </ul>
        </section>
        ...
        <section class="space-y-4">
          <h2 class="text-xl md:text-2xl font-extrabold text-white tracking-tight border-b border-[#1e293b] pb-2">
            4. Crucial Strategies to Crack CBT Examinations
          </h2>
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div class="bg-[#0f1524] border border-[#1e293b] rounded-xl p-4 space-y-2">
              <h4 class="text-sm font-bold text-white flex items-center gap-2">
                <span>⏱️</span> Master the Clock
              </h4>
              <p class="text-xs text-[#8b949e] leading-relaxed">
                Most central exams allocate 180 minutes for 200 questions. This leaves less than 54 seconds per question. Replicate this constraint by practicing with real-time countdown timers.
              </p>
            </div>
            <div class="bg-[#0f1524] border border-[#1e293b] rounded-xl p-4 space-y-2">
              <h4 class="text-sm font-bold text-white flex items-center gap-2">
                <span>📊</span> Tackle Negative Markings
              </h4>
              <p class="text-xs text-[#8b949e] leading-relaxed">
                With a 1/3rd negative penalty, guessing can ruin your percentile rank. Only attempt borderline questions if you can confidently eliminate at least two incorrect options.
              </p>
            </div>
          </div>
        </section>
...
export function getArticleForTest(subjectId: string, testId: string): SeoArticle {
  ...
  if (cleanSubId === "mock_tests" || cleanTestId.includes("mock") || cleanTestId.includes("norcet")) {
    return SEO_ARTICLES.homepage; // Use deep central government homepage guide
  }
