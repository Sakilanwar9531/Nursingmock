...
export const SUBJECTS: Subject[] = [
 { id: 'anatomy', icon: '🫀', name: 'Anatomy & Physiology', tests: [
  { id: 'cell-tissues-1', icon: '🔬', title: 'CELL & TISSUE - 1', desc: 'Cell organelles, DNA structure, cytoplasm, membrane transport — first 30 questions.', questions: 30, mins: 30, ready: true, data: [
  ...
  { id: 'cell-tissues-2', icon: '🔬', title: 'CELL & TISSUE - 2', desc: 'Tissue types, SLE, mitosis, muscle tissue, sarcomere — middle 30 questions.', questions: 30, mins: 30, ready: true, data: [
  ...
  { id: 'cell-tissues-3', icon: '🔬', title: 'CELL & TISSUE - 3', desc: 'Biochemistry, cell division, proteins, gene therapy — final 30 questions.', questions: 10, mins: 10, ready: true, data: [
  ...
  { id: 'nervous-system-1', icon: '🧠', title: 'NERVOUS SYSTEM - 1', desc: 'Neurons, glial cells, neurotransmitters, meninges, CSF, brain anatomy.', questions: 30, mins: 30, ready: true, data: [
  ...
  { id: 'nervous-system-2', icon: '🧠', title: 'NERVOUS SYSTEM - 2', desc: 'Brain lobes, speech centres, autonomic nervous system, fight or flight.', questions: 30, mins: 30, ready: true, data: [
  ...
  { id: 'nervous-system-3', icon: '🧠', title: 'NERVOUS SYSTEM - 3', desc: 'Spinal cord, cranial nerves, nerve functions, plexuses and reflexes.', questions: 21, mins: 21, ready: true, data: [
  ...
  { id: 'blood-mock-1', icon: '🩸', title: 'BLOOD & CIRCULATION - 1', desc: 'Basic blood pH, physiology, plasma proteins, osmotic pressure, and hematopoiesis.', questions: 50, mins: 50, ready: true, data: MOCK_1_DATA },
   { id: 'blood-mock-2', icon: '🩸', title: 'BLOOD & CIRCULATION - 2', desc: 'RBC disorders, anemic indices, sickle cell crisis, thalassemia, and B12 deficiency.', questions: 50, mins: 50, ready: true, data: MOCK_2_DATA },
   { id: 'blood-mock-3', icon: '🩸', title: 'BLOOD & CIRCULATION - 3', desc: 'White blood cells, inflammatory cascade, immunology, vaccines, and CD4+ counts.', questions: 50, mins: 50, ready: true, data: MOCK_3_DATA },
   { id: 'blood-mock-4', icon: '🩸', title: 'BLOOD & CIRCULATION - 4', desc: 'Platelets, clotting cascade, coagulation pathways, heparin vs warfarin, and bleeding protocols.', questions: 50, mins: 50, ready: true, data: MOCK_4_DATA },
   { id: 'blood-mock-5', icon: '🩸', title: 'BLOOD & CIRCULATION - 5', desc: 'Transfusion reactions, blood typing compatibility, malignancies like Hodgkins and Leukemia, and advanced DIC.', questions: 48, mins: 48, ready: true, data: MOCK_5_DATA },
